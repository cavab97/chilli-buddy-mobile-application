...
const searchReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case actions.TOGGLE_SEARCH_PROMO_SHOP_FAVOURITE:
      return {
        ...state,
        promos: payload.data.promos,
        promo: payload.data.promo !== null ? payload.data.promo : state.promo,
      };
    ...
    case actions.TOGGLE_SEARCH_SHOP_FAVOURITE:
      return {
        ...state,
    ...
    case actions.TOGGLE_SEARCH_SHOP_FAVOURITE_ERROR:
      console.log(payload.data);
      return {
        ...state,
        favouriteError: payload.data,
    ...
    case actions.TOGGLE_SEARCH_SHOP_MESSAGES:
      return {
        ...state,
