                    ...
                    <FlatList
                        ...
                        <ScrollView>
                            <View style={singlePostContainer}>
                                ...
                                <Text style={{paddingTop: 5}}>{moment(item.created.at).format("DD/MM/YYYY")}</Text>
  ...
  return (
    <ScrollView>
        <View style={posterArea}>
            ...
            <MaterialCommunityIcons style={coverImageSwapLeft} name="chevron-left-circle" size={30} onPress={onClickToSwip.bind(this, "back")} />
            <MaterialCommunityIcons style={coverImageSwapRight} name="chevron-right-circle" size={30} onPress={onClickToSwip.bind(this, "next")} />
        </View>
                ...
                <View style={detailArea}>
                    ...
                    <View>
                        ...
                        <View style={setRow}>
                            ...
                            >
                                {dataSource.address.line1} {dataSource.address.line2} {dataSource.address.postcode} {dataSource.address.state}
                            </Text>
                        </View>
                    </View>

                    {dataSource.description && <View>
                    ...
                    <View 
                        ...
                        <Ionicons
                            ...
                            onPress={ ()=>{ 
                                ...
                                Linking.openURL("instagram://user?username=" +dataSource.instagramUrl.replace(/ /g, ''))
                            }}
                        />}
                ...
                { promotions.length > 0 &&
                    <View>
                        ...
                        <FlatList
                            ...
                            keyExtractor={item => item.id}
                            renderItem={({ item, index }) => 
                                <TouchableOpacity onPress={onPromoteClick.bind(this, item.id)}>
                                    <Card 
                                        key={item.id}
                                        style={ index === 0 ? firstPromoteCardStyle : promoteCardStyle }
                                    >
                                        {item.coverPhotos.length > 0 ? 
                                            <Image source={{uri:item.coverPhotos[0]}} style={promoteImage} resizeMode = "cover" />
                                        : 
                                            <Image source={noPromoteImage} style={promoteNoImage} resizeMode = "cover"/>
                                        }
                                        <Text numberOfLines={2} style={promoteTitleTextStyle}>{item.title}</Text>
                                    </Card>
                                </TouchableOpacity>
                            }
