...
const styles = StyleSheet.create({
  ...
  posterArea: {
    flex: 1,
    height: Platform.isPad ? 500 : Platform.OS === "ios" ? 250 : 250,
    borderBottomWidth: 0.5,
  },
  subContainer1: {
    // flex: 1,
    marginTop: Platform.isPad ? 0 : Platform.OS === "ios" ? 0 : 25,
    height: Platform.isPad ? "100%" : Platform.OS === "ios" ? "100%" : "90%",
